...
export const PRESET_FRIENDS: Friend[] = [
  // ==================================================================== 女性
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '4d9ea3a384294fe39dc9e235f7052ede',
      rate: 0.95,
      pitch: 1.0,
      voiceTuning: { temperature: 0.9, topP: 0.9, repetitionPenalty: 1.2, latency: 'normal' },
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '4f5d1e5c63fd41cfae6c2e4525962b48',
      rate: 0.88,
      pitch: 1.0,
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '2daca7855fa44ab6b6e994ee93e5bd48',
      rate: 0.9,
      pitch: 1.0,
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: 'be6cfb2466414562ae47c6791bb838ae',
      rate: 1.05,
      pitch: 1.0,
      voiceTuning: { volume: 3, temperature: 0.85, repetitionPenalty: 1.35, latency: 'normal' },
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: 'bcf813c406b74dcb81f69bd5ce52233f',
      rate: 1.0,
      pitch: 1.0,
      voiceTuning: { temperature: 0.85, latency: 'normal' },
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '6311cdf5503543a8882c708f46f380fc',
      rate: 0.9,
      pitch: 1.0,
      voiceTuning: { latency: 'normal', temperature: 0.85, topP: 0.8 },
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '5fb61ddb286e4654bc86b4c02bfe8610',
      rate: 1.0,
      pitch: 1.0,
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '6da564fca05949fe99d7e4f176090bd5',
      rate: 1.0,
      pitch: 1.0,
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '1dde863d039b428d906479774b65de6a',
      rate: 0.95,
      pitch: 1.0,
      voiceTuning: { temperature: 0.9, topP: 0.9, repetitionPenalty: 1.2 },
    },
    initialMessage: {
  ...
  },
  {
    ...
    voice: {
      gender: 'female',
      voiceModel: '80e1c4a910f44041b5204e145ed38154',
      rate: 0.93,
      pitch: 1.0,
      voiceTuning: { temperature: 0.9, topP: 0.9, repetitionPenalty: 1.2, latency: 'normal' },
    },
