...
export function LogoIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <circle cx="12" cy="12" r="10" fill="currentColor" fillOpacity="0.15" stroke="currentColor" />
      <path d="M12 4v16" stroke="currentColor" strokeWidth="2.5" />
      <rect x="7" y="8" width="10" height="8" rx="1.5" stroke="currentColor" strokeWidth="2" fill="none" />
    </svg>
  )
}
